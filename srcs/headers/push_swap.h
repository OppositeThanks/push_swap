...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/27 12:09:50 by lperrin           #+#    #+#             */
/*   Updated: 2022/07/20 10:42:12 by lperrin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_one_hundred(t_stacks *stacks);
void			ft_five_hundred(t_stacks *stacks);
...
void			ft_sort_more_then_hundred(t_stacks *stacks);
